...
class StoreQueueEntryRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'customer_name.max' => 'Customer name may not exceed 255 characters.',
            'phone_number.required' => 'Phone number is required.',
            'phone_number.string' => 'Phone number must be a string.',
            'phone_number.max' => 'Phone number may not exceed 20 characters.',
            'order_details.json' => 'Order details must be a valid JSON.',
            'quantity_purchased.required' => 'Quantity purchased is required.',
